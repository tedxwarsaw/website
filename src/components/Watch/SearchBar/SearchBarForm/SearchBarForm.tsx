...
export const SearchBarForm = ({
  ...
  return (
    <div className="bg-white md:flex justify-between items-center xl:px-8 rounded-md font-light col-start-2 col-end-3 md:col-end-5 xl:col-end-7 flex-col px-4 py-1 xl:flex xl:flex-row shadow-lg z-10 search-bar-form">
