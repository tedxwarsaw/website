...
export const EventHighlight = ({
  ...
  return (
    <div className="main-grid-full-span relative">
      <Lines wider={true} />
      <div className="pb-16 main-grid main-grid-mobile-full-span relative">
        ...
        <div className="px-5 md:px-0">
          <div className="w-full py-10 z-10">
            <p className="text-2xl md:text-3xl">{eventHeader}</p>
            <p className="text-2xl md:text-3xl font-bold">{eventEdition}</p>
          </div>
