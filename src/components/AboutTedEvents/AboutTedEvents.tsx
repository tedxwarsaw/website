...
export const AboutTedEvents = (props : TedEventsProps) => (
    <div className={`${props.background == "white" ? '' : 'bg-customLightGrey'} main-grid-full-span`}>
        <div className="main-grid pt-10 pb-10">
            <div className={`items-top ${props.titleFontClass} col-start-1 col-end-full`}>
                <ReactMarkdown rehypePlugins={[rehypeRaw]}>{props.aboutTedEventsTitle}</ReactMarkdown>
            </div>
            <div className={"inner-grid mt-8"}>
