    ...
    <div className="main-grid-full-span">
        ...
        <div className="seamless-grid pt-20 pb-20">
            <div className="flex items-top col-start-2 col-end-3 text-2xl md:text-3xl">
                <ReactMarkdown rehypePlugins={[rehypeRaw]}>{props.aboutTedWarsawTitle}</ReactMarkdown>
            </div>
            <div className="col-start-2 col-end-3 mt-8 md:col-start-2 md:col-end-5 md:mt-8 xl:col-start-4 xl:col-end-7 xl:mt-0 font-normal">
                {<ReactMarkdown rehypePlugins={[rehypeRaw]}>{props.aboutTedWarsawContent}</ReactMarkdown>}
            </div>
        </div>
    </div>
);
